...
/**
 * Servlet Filter implementation class FiltroPanelUsuario
 */
@WebFilter(urlPatterns = {"/panelusuario.jsp"})
public class FiltroPanelUsuario implements Filter {

    /**
     * Default constructor. 
     */
    public FiltroPanelUsuario() {
